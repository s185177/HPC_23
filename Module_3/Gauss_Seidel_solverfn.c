...
#define __PYX_HAVE__Gauss_Seidel_solverfn
#define __PYX_HAVE_API__Gauss_Seidel_solverfn
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'Gauss_Seidel_solverfn' */
...
#define __Pyx_MODULE_NAME "Gauss_Seidel_solverfn"
extern int __pyx_module_is_main_Gauss_Seidel_solverfn;
int __pyx_module_is_main_Gauss_Seidel_solverfn = 0;

/* Implementation of 'Gauss_Seidel_solverfn' */
...
static const char __pyx_k_Gauss_Seidel_solverfn[] = "Gauss_Seidel_solverfn";
static const char __pyx_k_contiguous_and_direct[] = "<contiguous and direct>";
static const char __pyx_k_MemoryView_of_r_object[] = "<MemoryView of %r object>";
static const char __pyx_k_MemoryView_of_r_at_0x_x[] = "<MemoryView of %r at 0x%x>";
static const char __pyx_k_contiguous_and_indirect[] = "<contiguous and indirect>";
static const char __pyx_k_Cannot_index_with_type_s[] = "Cannot index with type '%s'";
static const char __pyx_k_Gauss_Seidel_solverfn_pyx[] = "Gauss_Seidel_solverfn.pyx";
static const char __pyx_k_Invalid_shape_in_axis_d_d[] = "Invalid shape in axis %d: %d.";
static const char __pyx_k_itemsize_0_for_cython_array[] = "itemsize <= 0 for cython.array";
static const char __pyx_k_unable_to_allocate_array_data[] = "unable to allocate array data.";
static const char __pyx_k_strided_and_direct_or_indirect[] = "<strided and direct or indirect>";
static const char __pyx_k_Created_on_Thu_Mar_2_16_30_35_2[] = "\nCreated on Thu Mar  2 16:30:35 2023\n\n@author: runep\n";
...
static PyObject *__pyx_n_s_Gauss_Seidel_solverfn;
static PyObject *__pyx_kp_s_Gauss_Seidel_solverfn_pyx;
...
static PyObject *__pyx_pf_21Gauss_Seidel_solverfn_gauss_seidel_numpy(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_f); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_21Gauss_Seidel_solverfn_1gauss_seidel_numpy(PyObject *__pyx_self, PyObject *__pyx_arg_f); /*proto*/
static PyMethodDef __pyx_mdef_21Gauss_Seidel_solverfn_1gauss_seidel_numpy = {"gauss_seidel_numpy", (PyCFunction)__pyx_pw_21Gauss_Seidel_solverfn_1gauss_seidel_numpy, METH_O, 0};
static PyObject *__pyx_pw_21Gauss_Seidel_solverfn_1gauss_seidel_numpy(PyObject *__pyx_self, PyObject *__pyx_arg_f) {
  ...
  assert(__pyx_arg_f); {
    __pyx_v_f = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(__pyx_arg_f, PyBUF_WRITABLE); if (unlikely(!__pyx_v_f.memview)) __PYX_ERR(0, 11, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("Gauss_Seidel_solverfn.gauss_seidel_numpy", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_21Gauss_Seidel_solverfn_gauss_seidel_numpy(__pyx_self, __pyx_v_f);
...
static PyObject *__pyx_pf_21Gauss_Seidel_solverfn_gauss_seidel_numpy(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_f) {
  __Pyx_memviewslice __pyx_v_f_new = { 0, 0, { 0 }, { 0 }, { 0 } };
 ...
 */
  __pyx_t_1 = __pyx_memoryview_copy_slice_d_dc_double_c(__pyx_v_f); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 12, __pyx_L1_error)
  __pyx_v_f_new = __pyx_t_1;
  __pyx_t_1.memview = NULL;
  __pyx_t_1.data = NULL;

  /* "Gauss_Seidel_solverfn.pyx":13
 * def gauss_seidel_numpy(double[:,:] f):
 *     cdef double[:,:] f_new = f.copy()
 *     cdef double scalar = 0.25             # <<<<<<<<<<<<<<
 *     cdef unsigned int i, j
 ...
 */
  __pyx_t_2 = ((__pyx_v_f_new.shape[0]) - 1);
  __pyx_t_3 = __pyx_t_2;
  for (__pyx_t_4 = 1; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    __pyx_v_i = __pyx_t_4;

    /* "Gauss_Seidel_solverfn.pyx":17
 * 
 *     for i in range(1,f_new.shape[0]-1):
 *         for j in range(1,f_new.shape[1]-1):             # <<<<<<<<<<<<<<
 *             f_new[i,j] = scalar * (f_new[i,j+1] + f_new[i,j-1] +
 ...
 */
    __pyx_t_5 = ((__pyx_v_f_new.shape[1]) - 1);
    __pyx_t_6 = __pyx_t_5;
    for (__pyx_t_7 = 1; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
      __pyx_v_j = __pyx_t_7;

      /* "Gauss_Seidel_solverfn.pyx":18
 *     for i in range(1,f_new.shape[0]-1):
 *         for j in range(1,f_new.shape[1]-1):
 *             f_new[i,j] = scalar * (f_new[i,j+1] + f_new[i,j-1] +             # <<<<<<<<<<<<<<
 *                                    f_new[i+1,j] + f_new[i-1,j])
 ...
 */
      ...
      __pyx_t_10 = -1;
      if (unlikely(__pyx_t_8 >= (size_t)__pyx_v_f_new.shape[0])) __pyx_t_10 = 0;
      if (__pyx_t_9 < 0) {
        __pyx_t_9 += __pyx_v_f_new.shape[1];
        if (unlikely(__pyx_t_9 < 0)) __pyx_t_10 = 1;
      } else if (unlikely(__pyx_t_9 >= __pyx_v_f_new.shape[1])) __pyx_t_10 = 1;
      ...
      __pyx_t_10 = -1;
      if (unlikely(__pyx_t_11 >= (size_t)__pyx_v_f_new.shape[0])) __pyx_t_10 = 0;
      if (__pyx_t_12 < 0) {
        __pyx_t_12 += __pyx_v_f_new.shape[1];
        if (unlikely(__pyx_t_12 < 0)) __pyx_t_10 = 1;
      } else if (unlikely(__pyx_t_12 >= __pyx_v_f_new.shape[1])) __pyx_t_10 = 1;
      if (unlikely(__pyx_t_10 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_10);
        __PYX_ERR(0, 18, __pyx_L1_error)
      }

      /* "Gauss_Seidel_solverfn.pyx":19
 *         for j in range(1,f_new.shape[1]-1):
 *             f_new[i,j] = scalar * (f_new[i,j+1] + f_new[i,j-1] +
 *                                    f_new[i+1,j] + f_new[i-1,j])             # <<<<<<<<<<<<<<
 *     return f_new
 */
      ...
      __pyx_t_10 = -1;
      if (__pyx_t_13 < 0) {
        __pyx_t_13 += __pyx_v_f_new.shape[0];
        if (unlikely(__pyx_t_13 < 0)) __pyx_t_10 = 0;
      } else if (unlikely(__pyx_t_13 >= __pyx_v_f_new.shape[0])) __pyx_t_10 = 0;
      if (unlikely(__pyx_t_14 >= (size_t)__pyx_v_f_new.shape[1])) __pyx_t_10 = 1;
      if (unlikely(__pyx_t_10 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_10);
 ...
 */
      ...
      __pyx_t_10 = -1;
      if (__pyx_t_15 < 0) {
        __pyx_t_15 += __pyx_v_f_new.shape[0];
        if (unlikely(__pyx_t_15 < 0)) __pyx_t_10 = 0;
      } else if (unlikely(__pyx_t_15 >= __pyx_v_f_new.shape[0])) __pyx_t_10 = 0;
      if (unlikely(__pyx_t_16 >= (size_t)__pyx_v_f_new.shape[1])) __pyx_t_10 = 1;
      if (unlikely(__pyx_t_10 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_10);
        __PYX_ERR(0, 19, __pyx_L1_error)
      }
 ...
 */
      ...
      __pyx_t_10 = -1;
      if (unlikely(__pyx_t_17 >= (size_t)__pyx_v_f_new.shape[0])) __pyx_t_10 = 0;
      if (unlikely(__pyx_t_18 >= (size_t)__pyx_v_f_new.shape[1])) __pyx_t_10 = 1;
      if (unlikely(__pyx_t_10 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_10);
        __PYX_ERR(0, 18, __pyx_L1_error)
      }
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_f_new.data + __pyx_t_17 * __pyx_v_f_new.strides[0]) ) + __pyx_t_18 * __pyx_v_f_new.strides[1]) )) = (__pyx_v_scalar * ((((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_f_new.data + __pyx_t_8 * __pyx_v_f_new.strides[0]) ) + __pyx_t_9 * __pyx_v_f_new.strides[1]) ))) + (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_f_new.data + __pyx_t_11 * __pyx_v_f_new.strides[0]) ) + __pyx_t_12 * __pyx_v_f_new.strides[1]) )))) + (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_f_new.data + __pyx_t_13 * __pyx_v_f_new.strides[0]) ) + __pyx_t_14 * __pyx_v_f_new.strides[1]) )))) + (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_f_new.data + __pyx_t_15 * __pyx_v_f_new.strides[0]) ) + __pyx_t_16 * __pyx_v_f_new.strides[1]) )))));
    }
  }

  /* "Gauss_Seidel_solverfn.pyx":20
 *             f_new[i,j] = scalar * (f_new[i,j+1] + f_new[i,j-1] +
 *                                    f_new[i+1,j] + f_new[i-1,j])
 *     return f_new             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_19 = __pyx_memoryview_fromslice(__pyx_v_f_new, 2, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 20, __pyx_L1_error)
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_f_new, 1);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "Gauss_Seidel_solverfn.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "Gauss_Seidel_solverfn.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "Gauss_Seidel_solverfn.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "Gauss_Seidel_solverfn._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_Gauss_Seidel_solverfn(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_Gauss_Seidel_solverfn},
  {0, NULL}
};
#endif
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "Gauss_Seidel_solverfn",
    __pyx_k_Created_on_Thu_Mar_2_16_30_35_2, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_Gauss_Seidel_solverfn, __pyx_k_Gauss_Seidel_solverfn, sizeof(__pyx_k_Gauss_Seidel_solverfn), 0, 0, 1, 1},
  {&__pyx_kp_s_Gauss_Seidel_solverfn_pyx, __pyx_k_Gauss_Seidel_solverfn_pyx, sizeof(__pyx_k_Gauss_Seidel_solverfn_pyx), 0, 0, 1, 0},
 ...
 *     cdef double scalar = 0.25
 */
  __pyx_tuple__22 = PyTuple_Pack(6, __pyx_n_s_f, __pyx_n_s_f, __pyx_n_s_f_new, __pyx_n_s_scalar, __pyx_n_s_i, __pyx_n_s_j); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__22);
  __Pyx_GIVEREF(__pyx_tuple__22);
  __pyx_codeobj__23 = (PyObject*)__Pyx_PyCode_New(1, 0, 6, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__22, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Gauss_Seidel_solverfn_pyx, __pyx_n_s_gauss_seidel_numpy, 11, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__23)) __PYX_ERR(0, 11, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initGauss_Seidel_solverfn(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initGauss_Seidel_solverfn(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_Gauss_Seidel_solverfn(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_Gauss_Seidel_solverfn(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_Gauss_Seidel_solverfn(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'Gauss_Seidel_solverfn' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_Gauss_Seidel_solverfn(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("Gauss_Seidel_solverfn", __pyx_methods, __pyx_k_Created_on_Thu_Mar_2_16_30_35_2, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_Gauss_Seidel_solverfn) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "Gauss_Seidel_solverfn")) {
      if (unlikely(PyDict_SetItemString(modules, "Gauss_Seidel_solverfn", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     cdef double scalar = 0.25
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_21Gauss_Seidel_solverfn_1gauss_seidel_numpy, NULL, __pyx_n_s_Gauss_Seidel_solverfn); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_gauss_seidel_numpy, __pyx_t_1) < 0) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "Gauss_Seidel_solverfn.pyx":1
 * # -*- coding: utf-8 -*-             # <<<<<<<<<<<<<<
 * """
 * Created on Thu Mar  2 16:30:35 2023
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init Gauss_Seidel_solverfn", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init Gauss_Seidel_solverfn");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
